...
- Ссылка проект: https://sergimax.github.io/react-vite-ts-starter/#/

## Спринт 6 - Этап 1

- [x] Этап тестирования реализован полностью:
...
- [x] Проект размещён на GitHub Pages или на своём сервере. В README.md приведена ссылка на него
...
2. [x] Доработка роутинга в приложенииw
